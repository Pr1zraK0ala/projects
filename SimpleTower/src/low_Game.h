#ifndef SRC_LOW_GAME_H
#define SRC_LOW_GAME_H
 ...
 */
/**
 * The low_Game class which represents a low difficulty game.
 */
class low_Game : public default_Game{
protected:
public:
/**
